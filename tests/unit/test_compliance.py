...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("is this harassment", SensitiveTopic.HARASSMENT),
        ("my manager keeps bullying me", SensitiveTopic.HARASSMENT),
        ("he keeps making inappropriate comments", SensitiveTopic.HARASSMENT),
        ...
        ("what is my salary this month", SensitiveTopic.SALARY),
        ("how much does my team lead earn", SensitiveTopic.SALARY),
        ("what are the salaries of the designers", SensitiveTopic.SALARY),
        ("can I take sick leave for surgery", SensitiveTopic.MEDICAL),
        ("I have a mental health condition, who do I tell", SensitiveTopic.MEDICAL),
        ("can I sue the company", SensitiveTopic.LEGAL),
        ("I need legal advice about my contract", SensitiveTopic.LEGAL),
        ("should I talk to an employment lawyer", SensitiveTopic.LEGAL),
