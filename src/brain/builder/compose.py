...
`console/src/components/ManifestForm.tsx`, which renders it. M20.1.3, a co-author whose proposed
changes the author accepts or rejects one by one, is `brain.builder.coauthor`. M20.1.4, a manifest
